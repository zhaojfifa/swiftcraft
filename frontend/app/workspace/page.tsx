        ...
        <div className='w-[400px] bg-white border-r border-slate-200 flex flex-col z-10 shadow-[4px_0_24px_rgba(0,0,0,0.02)]'>
          ...
          <div className='p-6 space-y-8 overflow-y-auto flex-1'>
            <div className='space-y-3'>
              ...
              <div className='border border-dashed border-slate-300 rounded-xl h-36 flex flex-col items-center justify-center bg-slate-50 hover:bg-slate-100 hover:border-slate-400 transition cursor-pointer group'>
          ...
          <div className='p-6 border-t border-slate-100 bg-white'>
            <button className={`w-full py-3.5 rounded-xl font-bold text-white flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all ${
            ...
            <div className='w-full max-w-4xl mt-6 animate-in slide-in-from-bottom-4 fade-in duration-500'>
              ...
              <div className='bg-white border border-slate-200 rounded-lg p-4 shadow-sm font-mono text-xs h-32 overflow-y-auto'>
                <div className='flex gap-3 py-1 border-b border-slate-50'>
                  <span className='text-slate-400 w-12 select-none'>[00:01]</span>
                  <span className='text-slate-700'>Initializing distributed pipeline...</span>
                </div>
                <div className='flex gap-3 py-1 border-b border-slate-50'>
                  <span className='text-slate-400 w-12 select-none'>[00:02]</span>
                  <span className='text-blue-600 font-bold'>Gemini Flash</span>
                  <span className='text-slate-600'>Analyzing video context & lighting...</span>
                </div>
                <div className='flex gap-3 py-1 border-b border-slate-50'>
                  <span className='text-slate-400 w-12 select-none'>[00:05]</span>
                  <span className='text-emerald-600 font-bold'>FFmpeg Slicer</span>
                  <span className='text-slate-600'>Generated 3 chunks with 0.5s overlap</span>
                </div>
                <div className='flex gap-3 py-1'>
                  <span className='text-slate-400 w-12 animate-pulse select-none'>[00:06]</span>
                  <span className='text-slate-500 italic'>Dispatching to GPU cluster...</span>
                </div>
              </div>
            </div>
          )}
